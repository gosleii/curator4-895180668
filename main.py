...
def anatomy(message):
    bot.send_message(message.chat.id,
                     ...
                     'Короткие видео для повторения материала - [Easy Anatomy](https: // youtube.com / @ easyanatomyapplication?si = zsgtOnSdC59BKTPZ)')
...
def chemistry(message):
    bot.send_message(message.chat.id,
                     ...
                     '[Биохимия врисункахисхемах](https: // youtube.com / @ risuem_biohimiyu?si=H1u7nEhUtw__Xyqa)')
...
def pharma(message):
    bot.send_message(message.chat.id,
                     ...
                     '[Лучшие лекции по фармакологии](https: // youtube.com / @ scidrugs?si=UqLB4sSaitSVyMt1)')
